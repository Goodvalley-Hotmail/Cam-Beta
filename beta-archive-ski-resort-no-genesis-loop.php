...
add_action( 'genesis_before_while', 'archive_ski_resorts_breadcrumbs_part_1' );
function archive_ski_resorts_breadcrumbs_part_1() {
	global $wp_query;
...
add_action( 'genesis_after_endwhile', 'archive_ski_resorts_breadcrumbs_part_3' );
function archive_ski_resorts_breadcrumbs_part_3() {
	$wp_query->is_singular = $old_singular_value;
}
// BreadCrumbs in every Post found -> PART 3/3 END

add_action( 'genesis_entry_content', 'archive_ski_resorts_content' );
/**
 * Content for the Ski Resorts Archive Page.
 *
 * @since   1.0.0
 *
 * @return void
 */
function archive_ski_resorts_content() {
