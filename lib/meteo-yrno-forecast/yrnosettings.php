...
if ( !isset ( $insideTemplate ) ) {
	...
	#
	$latitude	= '50.89518'; // for Baqueira
	$longitude	= '4.69741'; // for Baqueira
	#
...
# directory settings
#-----------------------------------------------------------------------
$cacheDir		= $scriptDir . '/wp-content/themes/cameraski/lib/meteo-yrno-forecast/cache/'; // the retrieved information is cached here
$langDir		= $scriptDir . '/wp-content/themes/cameraski/lib/meteo-yrno-forecast/lang/'; // all language files are store here
$javascriptsDir	= $scriptDir . '/wp-content/themes/cameraski/lib/meteo-yrno-forecast/javaScripts/'; // contains the javascripts for graphs
$iconsDir		= $scriptDir . '/wp-content/themes/cameraski/lib/meteo-yrno-forecast/img/'; // all icons are stored here in separate folders
$imgDir	    	= $scriptDir . '/wp-content/themes/cameraski/lib/meteo-yrno-forecast/img/'; // contains images like sun-up  sun-down
#-----------------------------------------------------------------------
# the icon folders 
#-----------------------------------------------------------------------
