...
//$cacheDir	= $_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/cameraski/lib/meteo/cache/'; // CARLES LOCAL
$langDir	= $scriptDir . 'lang/'; // all language files are store here
//$langDir	= $_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/cameraski/lib/meteo/lang/'; // CARLES LOCAL
//$javascriptsDir	= $scriptDir . 'javaScripts/'; // contains the javascripts for graphs // CARLES LOCAL
//$iconsDir	= $scriptDir . 'img/'; // all icons are stored here in separate folders // CARLES LOCAL
