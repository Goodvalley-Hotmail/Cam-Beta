...
# directory settings
#-----------------------------------------------------------------------
$cacheDir	= $scriptDir.'/wp-content/themes/genesis-sample/meteo-yrno/cache/'; // the retrieved information is cached here
$langDir	= $scriptDir.'/wp-content/themes/genesis-sample/meteo-yrno/lang/'; // all language files are store here
$javascriptsDir	= $scriptDir.'/wp-content/themes/genesis-sample/meteo-yrno/javaScripts/'; // contains the javascripts for graphs
$iconsDir	= $scriptDir.'/wp-content/themes/genesis-sample/meteo-yrno/img/'; // all icons are stored here in separate folders
$imgDir	    = $scriptDir.'/wp-content/themes/genesis-sample/meteo-yrno/img/'; // contains images like sun-up  sun-down
#-----------------------------------------------------------------------
# the icon folders 
#-----------------------------------------------------------------------
