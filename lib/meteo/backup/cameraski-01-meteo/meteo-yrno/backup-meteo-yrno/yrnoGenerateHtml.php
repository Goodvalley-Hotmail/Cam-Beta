...
$script		= site_url( '/wp-content/themes/genesis-sample-develop/meteo-yrno/yrnosettings.php' );

//include $script;
include ( $_SERVER['DOCUMENT_ROOT'] . "/wp-content/themes/genesis-sample-develop/meteo-yrno/yrnosettings.php" );

$script		= $scriptDir . 'yrnoCreateArr.php';

//include $script;
include ( $_SERVER['DOCUMENT_ROOT'] . "/wp-content/themes/genesis-sample-develop/meteo-yrno/yrnoCreateArr.php" );
...
//include $script;
include ( $_SERVER['DOCUMENT_ROOT'] . "/wp-content/themes/genesis-sample-develop/meteo-yrno/yrnoCreateDetailArr.php" );
