...
$cacheDir	= $_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/genesis-sample-develop/meteo-yrno/cache/';
//$langDir	= $scriptDir . 'lang/'; // all language files are store here
$langDir	= $_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/genesis-sample-develop/meteo-yrno/lang/';
...
function yrnoIcon ( $iconIn ) {
	...
	global  $iconsOwn, $iconsXml, $iconsXmlSmall, $iconsXmlExt,
