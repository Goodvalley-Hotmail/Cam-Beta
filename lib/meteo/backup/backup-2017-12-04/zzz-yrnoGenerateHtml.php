...
$script		= site_url( '/wp-content/themes/cameraski/lib/meteo/yrnosettings.php' );

//include $script;
include ( $_SERVER['DOCUMENT_ROOT'] . "/wp-content/themes/cameraski/lib/meteo/yrnosettings.php" );
// AFEGIT
...
//include $script;
include ( $_SERVER['DOCUMENT_ROOT'] . "/wp-content/themes/cameraski/lib/meteo/yrnoCreateArr.php" );
// AFEGIT
echo '<!-- trying to load ' . $script . ' -->' . PHP_EOL;
*/
