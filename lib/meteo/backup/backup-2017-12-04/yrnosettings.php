...
if ( !isset ( $insideTemplate ) ) {
	...
	//$yrnoID	= 'Belgium/Flanders/Leuven/'; // generic adress
	$yrnoID		= get_post_meta( get_the_ID(), 'location_meteo', true );
	$iconsOwn	= true; // use original yrno icons or our general icons (false)
	
	//$yourArea	= 'yourArea'; // example Leuven
	$yourArea	= get_post_meta( get_the_ID(), 'resort_name', true );
...
# directory settings
#-----------------------------------------------------------------------
// LOCAL -> DESCOMENTAR LES LINIES MARCADES AMB ***
//$cacheDir	= $scriptDir.'cache/';// the retrieved information is cached here
// *** $cacheDir	= $_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/cameraski/lib/meteo/cache/';
$langDir	= $scriptDir . 'lang/'; // all language files are store here
// *** $langDir	= $_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/cameraski/lib/meteo/lang/';
...
$cacheDir		= $scriptDir.'/wp-content/themes/cameraski/lib/meteo/cache/'; // the retrieved information is cached here
$langDir		= $scriptDir.'/wp-content/themes/cameraski/lib/meteo/lang/'; // all language files are store here
$javascriptsDir	= $scriptDir.'/wp-content/themes/cameraski/lib/meteo/javaScripts/'; // contains the javascripts for graphs
$iconsDir		= $scriptDir.'/wp-content/themes/cameraski/lib/meteo/img/'; // all icons are stored here in separate folders
$imgDir	    	= $scriptDir.'/wp-content/themes/cameraski/lib/meteo/img/'; // contains images like sun-up  sun-down
...
function yrnoIcon ( $iconIn ) {
	...
	global  $iconsOwn, $iconsXml, $iconsXmlSmall, $iconsXmlExt,	$iconsDef, $iconsDefSmall, $iconsDefExt;
