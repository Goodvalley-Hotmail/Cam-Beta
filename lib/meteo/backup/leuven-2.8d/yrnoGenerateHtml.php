...
#-----------------------------------------------------------------------
#
$script	= $scriptDir.'/wp-content/themes/twentyfifteen-child/yrnosettings.php'; // we need hard coded directory path here because settings are not loaded yet.
echo '<!-- trying to load '.$script.' -->'.PHP_EOL;
include $script;
#
$script	= $scriptDir.'/wp-content/themes/twentyfifteen-child/yrnoCreateArr.php';
echo '<!-- trying to load '.$script.' -->'.PHP_EOL;
include $script;
...
#	        echo 'halt'; exit;
	} else {$timecheck      = $timecheck + $offset*60*60;
	        $dayText 	= yrnotransstr( date('l', $timecheck ) );
	}
...
$script	        = $scriptDir.'/wp-content/themes/twentyfifteen-child/yrnoCreateDetailArr.php';
echo '<!-- trying to load '.$script.' -->'.PHP_EOL;
include $script;
